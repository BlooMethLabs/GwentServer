...
function removeOtherPlayer(game, side) {
    ...
    game[remSide + ' Player'].Hand.Size = game[remSide + ' Player'].Hand.Cards.length;
    game[remSide + ' Player'].Hand.Cards = [];
    game[remSide + ' Player'].Deck.Size = game[remSide + ' Player'].Deck.Cards.length;
    game[remSide + ' Player'].Deck.Cards = [];
    return game;
}

export {removeOtherPlayer};